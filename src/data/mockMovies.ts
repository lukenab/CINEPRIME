...
// Shape matches MovieApiResponse so it can be dropped straight into NowShowing / ComingSoon.
export const mockMovies: MovieApiResponse[] = [
  {
    ...
    smallImage:
      "https://image.tmdb.org/t/p/w300/wWba3TaojhK7NdycRhoQpsG0FaH.jpg",
    movieType: ["Animation", "Comedy"],
    showTimes: [
      { showTimeId: 101, showDate: "2026-07-02", startTime: "19:30", endTime: "21:05", updateAt: "2026-06-25" },
    ],
    createAt: "2026-06-01",
  },
  {
    ...
    content:
      "Trải nghiệm ngày tận thế bắt đầu khi thành phố New York rơi vào im lặng tuyệt đối trước những sinh vật săn mồi theo âm thanh.",
    duration: 100,
    version: "IMAX",
    status: true,
    ...
    smallImage:
      "https://image.tmdb.org/t/p/w300/yrpPYKijwdMHyTGIOd1iK1h0Xno.jpg",
    movieType: ["Horror", "Sci-Fi"],
    showTimes: [
      { showTimeId: 102, showDate: "2026-07-03", startTime: "20:00", endTime: "21:40", updateAt: "2026-06-25" },
    ],
    createAt: "2026-06-02",
  },
  {
    ...
    content:
      "Riley bước vào tuổi dậy thì và trung tâm điều khiển cảm xúc đón nhận những vị khách hoàn toàn mới, dẫn đầu là Lo Âu.",
    duration: 96,
    version: "3D",
    status: true,
    ...
    showTimes: [
      { showTimeId: 103, showDate: "2026-07-01", startTime: "18:15", endTime: "19:51", updateAt: "2026-06-25" },
    ],
    createAt: "2026-06-03",
  },
  {
    ...
    content:
      "Nhiều thế hệ sau triều đại Caesar, một thủ lĩnh loài khỉ trẻ tuổi lên đường tìm kiếm sự thật quyết định tương lai của cả khỉ lẫn người.",
    duration: 145,
    version: "IMAX",
    status: true,
    ...
    showTimes: [
      { showTimeId: 104, showDate: "2026-07-04", startTime: "21:00", endTime: "23:25", updateAt: "2026-06-25" },
    ],
    createAt: "2026-06-04",
  },
  {
    ...
    showTimes: [
      { showTimeId: 105, showDate: "2026-07-05", startTime: "20:30", endTime: "22:38", updateAt: "2026-06-25" },
    ],
    createAt: "2026-06-05",
  },
  {
    ...
    content:
      "Hai thám tử Miami kỳ cựu phải đối mặt với cáo buộc nhắm vào người cố vấn đã khuất và lần đầu tiên trở thành kẻ bị truy nã.",
    duration: 115,
    version: "2D",
    status: true,
    ...
    smallImage:
      "https://image.tmdb.org/t/p/w300/oGythE98MYleE6mZlGs5oBGkux1.jpg",
    movieType: ["Action", "Crime"],
    showTimes: [
      { showTimeId: 106, showDate: "2026-07-06", startTime: "19:45", endTime: "21:40", updateAt: "2026-06-25" },
    ],
    createAt: "2026-06-06",
  },
  {
    ...
    content:
      "Bị bắt khỏi vùng đất Xanh, Furiosa trẻ tuổi phải tìm đường sống sót qua vùng hoang mạc khốc liệt và lên kế hoạch trở về nhà.",
    duration: 148,
    version: "IMAX",
    status: true,
    ...
    showTimes: [
      { showTimeId: 107, showDate: "2026-07-07", startTime: "20:15", endTime: "22:43", updateAt: "2026-06-25" },
    ],
    createAt: "2026-06-07",
  },
  {
    ...
    smallImage:
      "https://image.tmdb.org/t/p/w300/p6AbOJvMQhBmffd0PIv0u8ghWeY.jpg",
    movieType: ["Animation", "Family"],
    showTimes: [
      { showTimeId: 108, showDate: "2026-07-08", startTime: "17:30", endTime: "19:11", updateAt: "2026-06-25" },
    ],
    createAt: "2026-06-08",
  },
];
